...
from (values
  ...
  (2,  'A cowboy hat on someone who has never worn one', 'easy'),
  ...
  (10, 'Sequins catching the light', 'easy'),
  (11, 'Fifteen takes of the same photo', 'easy'),
  ...
  (15, 'Waiting outside while the group is inside', 'easy'),
  (16, 'Filming the band through somebody''s head', 'easy'),
  (17, 'Food that cannot be walked and eaten at once', 'easy'),
  ...
  (24, 'Boots in the photo, not a face', 'medium'),
  ...
  (31, 'Shorts and a winter coat, ten feet apart', 'medium'),
  (32, 'A denim jacket with a name across the back', 'medium'),
  (33, 'A neck tattoo', 'medium'),
  (34, 'Sitting on the kerb, finished for the night', 'medium'),
  ...
  (40, 'A perfect boot scoot, well past seventy', 'hard')
) as v(ord, text, diff);
