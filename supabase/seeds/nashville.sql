...
from (values
  -- Within minutes of standing still.
  ...
  (6,  'Live music coming from three doorways at once', 'easy'),
  ...
  (11, 'A group stopped dead in the middle of the pavement, deciding', 'easy'),
  (12, 'Neon stacked three storeys up', 'easy'),
  ...
  -- Look around properly and you will get there.
  ...
  (26, 'A band playing hard to a nearly empty room', 'medium'),
  (27, 'Someone dancing alone, fully committed', 'medium'),
  (28, 'A piggyback down the sidewalk', 'medium'),
  (29, 'White sneakers already regretted', 'medium'),
  ...
  (33, 'Someone losing an argument with a scooter app', 'medium'),
  (34, 'Someone sitting on the kerb, finished for the night', 'medium'),
  (35, 'Someone carrying their shoes', 'medium'),
  (36, 'Someone checking the wrong licence plate for their ride', 'medium'),
