...
| ID | Sev | Bug | Notes |
|---|---|---|---|
| B-10 | Minor | **Presence counts browser tabs, not people.** Two tabs from the same player show "2 online". | Cosmetic. Fix is to dedupe by presence key. Tracked as gap G-15 since it's arguably incomplete work rather than a defect. |
